      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <h1 style="font-size: 40px; font-weight:bold">Update Categories</h1>
                ...
                <div class="div_deg">
                    ...
                    <img width="300" src="/Categories/{{$data->image}}">
                </div>
                ...
                <div class="div_deg">
                    <input class="btn btn-primary" type="submit" value="Update Categories">
                </div>
