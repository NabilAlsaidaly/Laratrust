      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <h1 style="font-size: 40px; font-weight:bold">Update SolarPanel</h1>
                <form action="{{url('edit_solar',$data->id)}}" method="Post" enctype="multipart/form-data">
                    @csrf
                <div class="div_deg">
                    <label>SolarPanel Name</label>
                ...
                <div class="div_deg">
                    ...
                    <input type="number" name="quantities" value="{{$data->quantities}}">
                </div>
                ...
                <div class="div_deg">
                    ...
                    <img width="300" src="/SolarPanel/{{$data->image}}">
                </div>
                ...
                <div class="div_deg">
                    <input class="btn btn-primary" type="submit" value="Update Solar">
                </div>
