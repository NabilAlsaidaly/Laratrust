      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <h1 style="font-size: 40px; font-weight:bold">Update Technician</h1>
                <form action="{{url('edit_technician',$data->id)}}" method="Post" enctype="multipart/form-data">
                    @csrf
                <div class="div_deg">
                ...
                <div class="div_deg">
                    ...
                    <img width="300" src="/Technician/{{$data->image}}">
                </div>
