      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <h1 style="font-size: 40px; font-weight:bold">Add Battery</h1>
                <form action="{{url('create_battery')}}" method="Post" enctype="multipart/form-data">
                    @csrf
                <div class="div_deg">
                ...
                <div class="div_deg">
                    <input class="btn btn-primary" type="submit" value="Add Battery">
                </div>
