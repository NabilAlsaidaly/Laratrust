        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    <h1 style="font-size: 40px; font-weight:bold">View Inverter</h1>
                    <div class="table-container">
                        ...
                        <tr>
                            ...
                            <td><img src="inverter/{{$data->image}}"></td>
                            <td>
                                <div class="btn-container">
                                    <a onclick="confirmDelete(event, '{{url('Delete_Inverter', $data->id)}}')" class="btn btn-danger" href="#">Delete</a>
                                    <a onclick="confirmUpdate(event, '{{url('Update_Inverter', $data->id)}}')" class="btn btn-update" href="{{url('company.Update_Inverter')}}">Update</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
