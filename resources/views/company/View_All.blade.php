                ...
                <div class="container-fluid">
                    ...
                    <div class="table-container">
                        ...
                        <tr>
                            ...
                            <td>{{ $inverter->quantities }}</td>
                            <td>{{ $inverter->capacity }}</td>
                            <td>{{ $inverter->description }}</td>
                            <td><img src="Inverter/{{ $inverter->image }}"></td>
                            <td>
                                <div class="btn-container">
                                    <a onclick="confirmDelete(event, '{{ url('Delete_Inverter', $inverter->id) }}')" class="btn btn-danger" href="#">Delete</a>
                                    <a onclick="confirmUpdate(event, '{{ url('Update_Inverter', $inverter->id) }}')" class="btn btn-update" href="{{ url('company.Update_Inverter') }}">Update</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                    ...
                    <table class="table_deg">
                        ...
                        <tr>
                            <td>{{ $battery->name }}</td>
                            <td>{{ $battery->price }}</td>
                            <td>{{ $battery->quantities }}</td>
                            <td>{{ $battery->capacity }}</td>
                            <td>{{ $battery->type }}</td>
                            <td><img src="Battery/{{ $battery->image }}"></td>
                            <td>
                                <div class="btn-container">
                                    <a onclick="confirmDelete(event, '{{ url('Delete_Battery', $battery->id) }}')" class="btn btn-danger" href="#">Delete</a>
                                    <a onclick="confirmUpdate(event, '{{ url('Update_Battery', $battery->id) }}')" class="btn btn-update" href="{{ url('company.Update_Battery') }}">Update</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                    ...
                    <table class="table_deg">
                        ...
                        <tr>
                            ...
                            <td>{{ $solarPanel->quantities }}</td>
                            <td>{{ $solarPanel->capacity }}</td>
                            <td>{{ $solarPanel->description }}</td>
                            <td><img src="SolarPanel/{{ $solarPanel->image }}"></td>
                            <td>
                                <div class="btn-container">
                                    <a onclick="confirmDelete(event, '{{ url('Delete_Solar', $solarPanel->id) }}')" class="btn btn-danger" href="#">Delete</a>
                                    <a onclick="confirmUpdate(event, '{{url('Update_Solar', $solarPanel->id)}}')" class="btn btn-update" href="{{url('company.Update_Solar')}}">Update</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                    ...
                    <table class="table_deg">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-container">
                                    <a onclick="confirmDelete(event, '{{url('Delete_Categories', $data->id)}}')" class="btn btn-danger" href="#">Delete</a>
                                    <a onclick="confirmUpdate(event, '{{url('Update_Categories', $data->id)}}')" class="btn btn-update" href="{{url('company.Update_Categories')}}">Update</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
