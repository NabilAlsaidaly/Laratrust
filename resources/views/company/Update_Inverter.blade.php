      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <h1 style="font-size: 40px; font-weight:bold">Update Inverter</h1>
                <form action="{{url('edit_inverter',$data->id)}}" method="Post" enctype="multipart/form-data">
                    @csrf
                <div class="div_deg">
                ...
                <div class="div_deg">
                    ...
                    <img width="300" src="/inverter/{{$data->image}}">
                </div>
                ...
                <div class="div_deg">
                    <input class="btn btn-primary" type="submit" value="Update Inverter">
                </div>
