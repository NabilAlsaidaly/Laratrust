...
<body>
        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    ...
                    <table id="userTable" class="table_deg">
                        <thead> <!-- أضفت العنوان هنا -->
                            <tr>
                                <th class="th_deg">Name</th>
                                <th class="th_deg">Phone</th>
                                <th class="th_deg">Information</th>
                                <th class="th_deg">Image</th>
                                <th class="th_deg">Work For</th>
                            </tr>
                        </thead> <!-- أضفت العنوان هنا -->
                        <tbody> <!-- هنا أيضًا -->
                            ...
                            <tr>
                                ...
                                <td>{{ $tech->phone }}</td>
                                <td>{{ $tech->info }}</td>
                                <td><img src="Technician/{{$tech->image}}"></td>
                                <td><a href="{{ url('View_Companies') }}"><h4>{{ $tech->company->name }}</h4></td>
                            </tr>
                            @endforeach
                        </tbody> <!-- هنا أيضًا -->
                    </table>
    ...
    <script type="text/javascript">
        function searchUsers() {
            ...
            tr = tbody.getElementsByTagName("tr"); // Get all rows in the tbody
