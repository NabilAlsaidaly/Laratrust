        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    <h1 style="font-size: 40px; font-weight:bold">View Companies</h1>
                    <div class="search-container">
                        <label for="searchInput">Search:</label>
                        <input type="text" id="searchInput" onkeyup="searchCompanies()" placeholder="">
                    </div>
                    <div class="table-container">
                        <table class="table_deg" id="companyTable">
                            ...
                            <tr>
                                ...
                                <td>{{$company->comm_id}}</td>
                                <td>{{$company->combank_id}}</td>
                                <td><a href= "{{ url('View_User') }}" class="btn btn-success" style="background-color: green" href="#">Information</a></td>
                            </tr>
                            @endforeach
                        </table>
                    </div>
