...
@endif
    ...
    <div class="container mb-5">
        <form id="searchForm" class="d-flex justify-content-center">
            <input id="searchInput" type="text" class="form-control me-2" placeholder="Search by name"
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp product-item" data-wow-delay="0.1s">
                        <div class="team-item rounded overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <p>{{ $categories->name }}</p>
                                <h5>Price:</h5>
                                <p class="product-price">{{ $categories->price }}</p>
                                <h5>Description:</h5>
                                ...
                                @endforeach
                                <a href="{{ route('cart.category', ['id' => $categories->id]) }}"
                                    style="display: inline-block; padding: 10px 20px; background-color: #088f0d; color: white; text-decoration: none; border-radius: 4px; font-size: 16px; transition: background-color 0.3s ease;">Add
                                    To Cart</a>
                            </div>
                        </div>
                    </div>
