                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp product-item" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex justify-content-center">
                            <img class="img-fluid w-75" src="/SolarPanel/{{ $solar->image }}" alt="{{ $solar->name }}">
                        </div>
                        <div class="p-4">
                            <h5>SolarPanel Name:</h5>
                            <p>{{ $solar->name }}</p>
                            <h5>Price:</h5>
                            <p class="product-price">{{ $solar->price }}</p>
                            <h5>Capacity:</h5>
                            <p>{{ $solar->capacity }}</p>
                            <h5>Description:</h5>
                            <p>{{ $solar->description }}</p>
                            <h5>Owner:</h5>
